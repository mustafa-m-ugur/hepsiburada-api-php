...
use CMD\Hepsiburada\models\requestmodels\order\PackageItemsRequestModel;
use CMD\Hepsiburada\models\requestmodels\order\SendDeliveryStatusRequestModel;
...
class OrderService extends HepsiburadaBaseService
{
     ...
     *
     * @param  string $packageNumber
     * @param  string $labelType CMD\Hepsiburada\models\basemodels\HepsiburadaTypes
     * @return HepsiburadaBaseResponseModel
     */
